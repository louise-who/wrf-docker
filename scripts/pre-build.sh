...
docker volume create GFS_volume
...
docker volume create namelist_volume
mv "$PARENTPATH/scripts/"operacional "$PARENTPATH/../docker/volumes/namelist_volume"
...
docker volume create WRF_out_volume
...
docker volume create relatorio_volume

#### MOVENDO SCRIPTS DAS FIGURAS PARA OUTRO DIRETORIO ##
mv "$PARENTPATH/scripts/"figuras "$PARENTPATH/.."


######## DADOS GEOGRÁFICOS ########
echo "Criando Volume para os dados geográficos.."
docker volume create GEOG_volume
