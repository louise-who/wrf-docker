...
'printim $FIGURAS/uv1000_3_2_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv850_3_2_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv700_3_2_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv200_3_2_'diaprev'_'horaprev'Z.gif'
...
*   'printim $FIGURAS/tsm_3_2_'diaprev'_'horaprev'Z.gif'
...
*   'xcbar 10.0 10.2 1.0 7.0 -line on -edge circle'
   ...
   'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/parnm_3_2_'diaprev'_'horaprev'Z.gif'
...
'set ccols 0 48 47 46 45 44 43 42 5 13 3 10 21 22 23 24 26 27 28 14'
   ...
   'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/t2m_3_2_'diaprev'_'horaprev'Z.gif'
...
*'set ccols 0 9 14 4 11 5 13 3 10 7 12 8 2 6'
   ...
   'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/prec_3_2_'diaprev'_'horaprev'Z.gif'
...
'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U1000_3_2_'diaprev'_'horaprev'Z.gif'
...
'set rgb 21 162 189 255'
   ...
   'draw string 2.2 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U850_3_2_'diaprev'_'horaprev'Z.gif'
