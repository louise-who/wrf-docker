...
'set strsiz 0.12'
'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv1000_3_3_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv850_3_3_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv700_3_3_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv200_3_3_'diaprev'_'horaprev'Z.gif'
...
*   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
*   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
*   'printim $FIGURAS/tsm_3_3_'diaprev'_'horaprev'Z.gif'
...
*   'xcbar -line on -edge circle'
   ...
   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/parnm_3_3_'diaprev'_'horaprev'Z.gif'
...
*   'set ccols 0 48 47 46 45 44 43 42 5 13 3 10 21 22 23 24 26 27 28'
   ...
   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/t2m_3_3_'diaprev'_'horaprev'Z.gif'
...
*'set ccols 0 9 14 4 11 5 13 3 10 7 12 8 2 6'
   ...
   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/prec_3_3_'diaprev'_'horaprev'Z.gif'
...
'set gxout shaded'
   ...
   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U1000_3_3_'diaprev'_'horaprev'Z.gif'
...
'set gxout shaded'
   ...
   'draw string 2.5 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.8 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U850_3_3_'diaprev'_'horaprev'Z.gif'


t=t+1
endwhile
" > $SCRIPTS/figuras_d03.gs
