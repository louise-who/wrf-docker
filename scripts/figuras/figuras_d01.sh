...
'set strsiz 0.12'
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv1000_3_1_'diaprev'_'horaprev'Z.gif'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv850_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv700_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv200_3_1_'diaprev'_'horaprev'Z.gif'
...
*   'printim $FIGURAS/tsm_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
*   'xcbar -line on -edge circle'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/parnm_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
'grads off'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/t2m_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
*   'set gxout shaded'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/prec_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
'set rgb 21 162 189 255'
 'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U1000_3_1_'diaprev'_'horaprev'Z.gif'
'c'
...
'set rgb 21 162 189 255'
 'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U850_3_1_'diaprev'_'horaprev'Z.gif'


t=t+1
endwhile
" > $SCRIPTS/figuras_d01.gs
